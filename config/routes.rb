...
Rails.application.routes.draw do
  ...
  post 'pain_behavior_extention_flexion/counternutation_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#counternutation_extention_flexion_behavior',
       as: 'pain_behavior_extention_flexion_counternutation_extention_flexion_behavior'
  ...
  get 'my_page_intervertebral_disk_guest', to: 'users#intervertebral_disk_guest',
                                           as: 'my_page_intervertebral_disk_guest'
  get 'intervertebral_joint', to: 'my_page#intervertebral_joint'
  get 'my_page_intervertebral_joint_guest', to: 'users#intervertebral_joint_guest',
                                            as: 'my_page_intervertebral_joint_guest'
  ...
  get 'guest_myofascial_back_pain_extention_flexion',
      to: 'pain_behavior_extention_flexion#myofascial_back_pain_extention_flexion_behavior'
  get 'guest_intervertebral_disk_extention_flexion',
      to: 'pain_behavior_extention_flexion#intervertebral_disk_extention_flexion_behavior'
  get 'guest_nutation_extention_flexion', to: 'pain_behavior_extention_flexion#nutation_extention_flexion_behavior'
  get 'guest_counternutation_extention_flexion',
      to: 'pain_behavior_extention_flexion#counternutation_extention_flexion_behavior'
  ...
  post 'pain_behavior_extention/intervertebral_disk_extention_behavior',
       to: 'pain_behavior_extention#intervertebral_disk_extention_behavior'
  post 'pain_behavior_extention/myofascial_back_pain_extention_behavior',
       to: 'pain_behavior_extention#myofascial_back_pain_extention_behavior'
  ...
  # カウンターニューテーション関連
  get 'pain_behavior_flexion/counternutation_flexion_behavior',
      to: 'pain_behavior_flexion#counternutation_flexion_behavior'
  post 'pain_behavior_flexion/counternutation_flexion_behavior',
       to: 'pain_behavior_flexion#counternutation_flexion_behavior'
  ...
  # 追加分
  delete 'myofascial_back_pain_guest', to: 'my_page#destroy_myofascial_back_pain_guest',
                                       as: 'my_page_destroy_myofascial_back_pain_guest'
  ...
  get 'intervertebral_joint_extention_flexion_behavior',
      to: 'pain_behavior_extention_flexion#intervertebral_joint_extention_flexion_behavior'
  get 'my_page_counternutation_guest', to: 'users#counternutation_guest', as: 'my_page_counternutation_guest_user'
  get 'new_guest_intervertebral_joint', to: 'my_page#new_guest_intervertebral_joint',
                                        as: 'new_guest_intervertebral_joint_page'
  ...
  get 'pain_behavior_extention_flexion/myofascial_back_pain_extention_flexion_behavior',
      to: 'pain_behavior_extention_flexion#myofascial_back_pain_extention_flexion_behavior'
  get 'pain_behavior_extention_flexion/unknown_extention_behavior_flexion',
      to: 'pain_behavior_extention_flexion#unknown_extention_behavior_flexion'
  get 'pain_behavior_flexion/myofascial_back_pain_flexion_behavior',
      to: 'pain_behavior_flexion#myofascial_back_pain_flexion_behavior'
  get 'pain_behavior_flexion/unknown_flexion_behavior', to: 'pain_behavior_flexion#unknown_flexion_behavior'
  get 'pain_location_extention_flexion', to: 'pain_location_extention_flexion#extention_flexion',
                                         as: 'pain_location_extention_flexion'
  ...
  get 'users/:id/myofascial_back_pain/:user_id', to: 'my_page#myofascial_back_pain_user',
                                                 as: 'my_page_myofascial_back_pain_user'
  ...
  post 'pain_behavior_extention_flexion/counternutation_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#counternutation_extention_flexion_behavior'
  post 'pain_behavior_extention_flexion/intervertebral_disk_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#intervertebral_disk_extention_flexion_behavior'
  post 'pain_behavior_extention_flexion/intervertebral_joint_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#intervertebral_joint_extention_flexion_behavior'
  post 'pain_behavior_extention_flexion/myofascial_back_pain_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#myofascial_back_pain_extention_flexion_behavior'
  post 'pain_behavior_extention_flexion/nutation_extention_flexion_behavior',
       to: 'pain_behavior_extention_flexion#nutation_extention_flexion_behavior', as: 'nutation_extention_flexion_behavior'
  post 'pain_behavior_flexion/counternutation_flexion_behavior',
       to: 'pain_behavior_flexion#counternutation_flexion_behavior'
  post 'pain_behavior_flexion/intervertebral_disk_flexion_behavior',
       to: 'pain_behavior_flexion#intervertebral_disk_flexion_behavior'
  post 'pain_behavior_flexion/intervertebral_disk_flexion_behavior',
       to: 'pain_behavior_flexion#intervertebral_disk_flexion_behavior', as: 'submit_intervertebral_disk_flexion_behavior'
  post 'pain_behavior_flexion/myofascial_back_pain_flexion_behavior',
       to: 'pain_behavior_flexion#myofascial_back_pain_flexion_behavior'
  post 'pain_behavior_flexion/nutation_flexion_behavior', to: 'pain_behavior_flexion#nutation_flexion_behavior',
                                                          as: 'nutation_flexion_behavior'
